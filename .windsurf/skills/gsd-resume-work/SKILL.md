...
<execution_context>
@C:/ContestA/.windsurf/get-shit-done/workflows/resume-project.md
</execution_context>

<process>
**Follow the resume-project workflow** from `@C:/ContestA/.windsurf/get-shit-done/workflows/resume-project.md`.
