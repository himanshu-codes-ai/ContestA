...
<!-- For checkpoint task examples and patterns, see @C:/ContestA/.windsurf/get-shit-done/references/checkpoints.md -->
...
See `C:/ContestA/.windsurf/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/ContestA/.windsurf/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/ContestA/.windsurf/get-shit-done/workflows/verify-phase.md` for verification logic.
