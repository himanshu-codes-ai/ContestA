...
**See @C:/ContestA/.codex/get-shit-done/references/checkpoints.md**
...
```bash
node C:/ContestA/.codex/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @C:/ContestA/.codex/get-shit-done/templates/summary.md
...
node "C:/ContestA/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "C:/ContestA/.codex/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
