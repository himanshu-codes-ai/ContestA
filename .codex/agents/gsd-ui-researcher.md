...
Use template from `C:/ContestA/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/ContestA/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/ContestA/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
