...
<execution_context>
@C:/ContestA/.claude/get-shit-done/workflows/new-workspace.md
@C:/ContestA/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @C:/ContestA/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
